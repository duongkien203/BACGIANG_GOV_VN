...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function updateBanner(wrapper, currentIndex) {
    ...
    wrapper.style.transform = `translateX(-${
      currentIndex * slideWidth + currentIndex * 9
    }px)`;
  }
  ...
  function createBanner(slideImages, containerSelector, isSmallBanner = false) {
    ...
    if (isSmallBanner) {
      ...
      const bannerContent = slideImages
        .map(
          (slide) =>
            `
    ...
    if (Array.isArray(content)) {
      ...
      return `
                <div class="tab-content-title">
                    <img class="tab-img" src="${content.img}" alt="${
        content.contentTitle
      }">
                    <h4>${content.contentTitle}<span> (${
        content.date
      })</span></h4>
  ...
  createTabs(
    "huyen-thixa-thanhpho-tabs",
    "huyen-thixa-thanhpho-content",
    huyenThixaThanhphoTabs
  );
  createTabs(
    "sbn-htxtp-hdt-tdhcdthcn-tabs",
    "sbn-htxtp-hdt-tdhcdthcn-content",
    sbnHtxtpHdtTdhcdthcnTabs
  );
...
const bigBannerSlides = [
  {
    ...
    title:
      "Bắc Giang ra mắt đơn vị hành chính thị xã Chũ và huyện Lục Ngạn; khai mạc Hội chợ cam, bưởi và Tuần Du lịch Lục Ngạn",
    link: "#",
  },
  {
    image: "./images/banner/banner-big/article_2.jpg",
    title:
      "Toàn văn phát biểu của Bí thư Tỉnh ủy Nguyễn Văn Gấu tại lễ ra mắt đơn vị hành chính thị xã Chũ và huyện Lục Ngạn và Hội chợ cam, bưởi và Tuần Du...",
    link: "#",
  },
  {
...
const libraryBannerSlides = [
  {
    ...
    title:
      "Một số hình ảnh Đại hội đại biểu MTTQ tỉnh Bắc Giang lần thứ XV, nhiệm kỳ 2024 - 2029",
    link: "#",
  },
  {
...
const smallBannerSlides = [
  {
    ...
    title:
      "Thanh tra Chính phủ sơ kết 5 năm thực hiện Luật Phòng, chống tham nhũng",
  ...
  },
  {
    ...
    title:
      "Chương trình nghệ thuật Chào mừng kỷ niệm 80 năm Ngày thành lập Quân đội Nhân...",
  ...
  },
  {
    ...
    title:
      "Lục Ngạn: Nhiều hoạt động đặc sắc tại Hội chợ cam, bưởi và Tuần Du lịch năm 2024",
  ...
  },
  {
    ...
    title:
      "Toàn văn phát biểu của Bí thư Tỉnh ủy Nguyễn Văn Gấu tại lễ ra mắt đơn vị...",
  ...
  },
  {
    ...
    title:
      "Bắc Giang ra mắt đơn vị hành chính thị xã Chũ và huyện Lục Ngạn; khai mạc Hội...",
  ...
  },
  {
    ...
    title:
      "Hơn 30 gian hàng được trưng bày tại Hội chợ cam, bưởi và Tuần Du lịch Lục...",
  ...
  },
  {
    ...
    title:
      "Một số hình ảnh trước lễ ra mắt đơn vị hành chính thị xã Chũ và huyện Lục...",
  ...
  },
  {
    ...
    title:
      "Ngành Nội vụ tổng kết công tác năm 2024, triển khai nhiệm vụ năm 2025",
    link: "#",
  },
  {
  ...
  },
  {
    ...
    title:
      "Tập trung cao triển khai hiệu quả các nhiệm vụ ngay từ tháng đầu năm của năm...",
    link: "#",
  },
  {
  ...
  },
  {
    ...
    title:
      "Phó Chủ tịch UBND tỉnh Phan Thế Tuấn thăm, chúc Tết một số cơ quan hợp tác...",
    link: "#",
  },
  {
    image: "./images/banner/banner-small/article_14.jpg",
    title:
      "Đoàn công tác tỉnh Bắc Giang thăm, chúc mừng Quân khu 1 và Bộ CHQS tỉnh",
    link: "#",
  },
  {
    image: "./images/banner/banner-small/article_15.png",
    title:
      "Đoàn đại biểu tỉnh Bắc Giang dâng hương tưởng niệm Đền thờ các anh hùng liệt...",
    link: "#",
  },
];
...
const dieuHanhTabs = [
  {
    ...
    content: {
      ...
      date: "26/12/2024",
      mainContent:
        "Chủ tịch UBND tỉnh Bắc Giang vừa ban hành Chỉ thị số 11/CT-UBND về việc tổ chức đón Tết Nguyên...",
      secondBlock: [
        {
          content:
            "Tăng cường giải pháp quản lý, vận hành bảo đảm an toàn hồ chứa nước",
          date: "25/12/2024",
        },
        {
          content:
            "Công bố danh mục thủ tục hành chính mới ban hành lĩnh vực chính sách, danh mục thủ tục hành chính...",
          date: "25/12/2024",
        },
        {
          content:
            "Bắc Giang đổi tên 08 đơn vị sự nghiệp trực thuộc Sở Giáo dục và Đào tạo",
          date: "24/12/2024",
        },
        {
  ...
  },
  {
    ...
    content: {
      ...
      date: "26/12/2024",
      mainContent:
        "Chính phủ ban hành Nghị định 160/2024/NĐ-CP về hoạt động đào tạo và sát hạch lái xe, trong đó quy...",
      secondBlock: [
        {
          content:
        ...
        {
          content:
            "Công bố thủ tục hành chính được sửa đổi, bổ sung lĩnh vực Lâm nghiệp",
          date: "24/12/2024",
        },
        {
          content:
            "Bộ Nội vụ điều chỉnh, bổ sung danh mục thủ tục hành chính lĩnh vực quản lý nhà nước về Hội và Quỹ",
          date: "24/12/2024",
        },
        {
          content:
            "Tăng cường phòng ngừa, xử lý hoạt động lừa đảo chiếm đoạt tài sản sử dụng công nghệ cao, trên...",
          date: "24/12/2024",
        },
        {
          content:
    ...
    content: [
      {
        ...
        contentTitle:
          "QĐ v/v cho phép chuyển mục đích sử dụng đất để thực hiện dự án: Khu đô thị Đồng Cửa 2, thị trấn... (26/12/2024)",
        documentPath: "#",
        downloadPath: "#",
      },
      {
        img: "./images/main-content/tabs/icon-vbpq-home.png",
        contentTitle:
          "KH Kiểm tra, rà soát văn bản và công tác pháp chế năm 2025 (26/12/2024)",
        documentPath: "#",
        downloadPath: "#",
      },
      {
        img: "./images/main-content/tabs/icon-vbpq-home.png",
        contentTitle:
          "KH Thực hiện công tác quản lý xử lý vi phạm hành chính trên địa bàn tỉnh Bắc Giang năm 2025 (26/12/2024)",
        documentPath: "#",
        downloadPath: "#",
      },
      {
        img: "./images/main-content/tabs/icon-vbpq-home.png",
        contentTitle:
          "QDD v/v Chủ tịch UBND tỉnh tặng Bằng khen và Danh hiệu năm 2024 (khối tham mưu tổng hợp) (25/12/2024)",
        documentPath: "#",
        downloadPath: "#",
      },
      {
        img: "./images/main-content/tabs/icon-vbpq-home.png",
        contentTitle:
          "QĐ v/v Xử phạt vi phạm hành chính đối với Hộ kinh doanh Lan Quý (25/12/2024)",
        documentPath: "#",
        downloadPath: "#",
      },
      {
        img: "./images/main-content/tabs/icon-vbpq-home.png",
        contentTitle:
          "QĐ v/v cho phép chuyển mục đích sử dụng đất để thực hiện Dự án đầu tư xây dựng và kinh doanh hạ... (25/12/2024)",
        documentPath: "#",
        downloadPath: "#",
      },
    ],
    ...
    content: [
      {
        img: "./images/main-content/tabs/icon-vbpq-home.png",
        contentTitle:
          "Dự hội nghị trực tuyến toàn quốc tổng kết công tác dân tộc năm 2024 và triển khai nhiệm vụ năm 2025 (25/12/2024)",
        documentPath: "#",
        downloadPath: "#",
      },
      {
        img: "./images/main-content/tabs/icon-vbpq-home.png",
        contentTitle:
          "V/v mời dự Hội nghị quán triệt, triển khai thi hành các luật, nghị quyết được thông qua tại Kỳ... (24/12/2024)",
        documentPath: "#",
        downloadPath: "#",
      },
      {
        img: "./images/main-content/tabs/icon-vbpq-home.png",
        contentTitle:
          "Mời dự Hội nghị trực tuyến tổng kết công tác năm 2024 và triển khai kế hoạch năm 2025 ngành Nông... (23/12/2024)",
        documentPath: "#",
        downloadPath: "#",
      },
      {
        img: "./images/main-content/tabs/icon-vbpq-home.png",
        contentTitle:
          "Giấy mời dự Hội nghị trực tuyến toàn quốc triển khai nhiệm vụ công tác năm 2025 của ngành Nội vụ (19/12/2024)",
        documentPath: "#",
        downloadPath: "#",
      },
      {
        img: "./images/main-content/tabs/icon-vbpq-home.png",
        contentTitle:
          "(Hỏa tốc) V/v thay đổi thời gian tổ chức Hội nghị UBND tỉnh thường kỳ tháng 12 năm 2024 (19/12/2024)",
        documentPath: "#",
        downloadPath: "#",
      },
      {
        img: "./images/main-content/tabs/icon-vbpq-home.png",
        contentTitle:
          "(HỎA TỐC) GM dự Hội nghị trực tuyến toàn quốc sơ kết 5 năm thực hiện Luật Phòng, chống tham nhũng (19/12/2024)",
        documentPath: "#",
        downloadPath: "#",
      },
    ],
  },
  {
    ...
    content: [
      ...
      },
      {
        img: "./images/main-content/tabs/icon-vbpq-home.png",
        contentTitle:
          "QĐ v/v cho Công ty cổ phần đầu tư và phát triển Hà Thịnh thuê đất để thực hiện Dự án đầu tư xây... (25/12/2024)",
        documentPath: "#",
        downloadPath: "#",
      },
      {
        img: "./images/main-content/tabs/icon-vbpq-home.png",
        contentTitle:
          "QĐ v/v Ủy quyền cho Sở Thông tin và Truyền thông tổ chức triển khai, quản lý, sử dụng dịch vụ... (25/12/2024)",
        documentPath: "#",
        downloadPath: "#",
      },
      {
        img: "./images/main-content/tabs/icon-vbpq-home.png",
        contentTitle:
          "KH Thực hiện công tác bồi thường nhà nước tỉnh Bắc Giang năm 2025 (25/12/2024)",
        documentPath: "#",
        downloadPath: "#",
      },
      {
        img: "./images/main-content/tabs/icon-vbpq-home.png",
        contentTitle:
          "KH tổ chức Hội nghị sơ kết công tác chỉ đạo, thực hiện Chuyển đổi số và Đề án 06/CP năm... (25/12/2024)",
        documentPath: "#",
        downloadPath: "#",
      },
    ],
...
const quyHoachTabs = [
  {
    ...
    content: {
      ...
      contentTitle:
        "Phê duyệt Đồ án Quy hoạch phân khu số 03 thị xã Việt Yên, tỉnh Bắc Giang",
      date: "23/12/2024",
      mainContent:
        "UBND tỉnh Bắc Giang vừa ban hành Quyết định phê duyệt Đồ án Quy hoạch phân khu số 03 thị xã Việt...",
      secondBlock: [
        {
          content:
        ...
        {
          content:
            "Phê duyệt Đồ án Quy hoạch phân khu số 01 thị xã Việt Yên, tỉnh Bắc Giang",
          date: "20/12/2024",
        },
        {
          content:
            "Phê duyệt Đồ án Quy hoạch phân khu số 02 thị xã Việt Yên, tỉnh Bắc Giang",
          date: "20/12/2024",
        },
        {
          content:
  ...
  },
  {
    ...
    content: {
      ...
      date: "29/10/2024",
      mainContent:
        "Ngày 28/10/2024, Thủ tướng Chính phủ ban hành Quyết định số 1279/QĐ-TTg phê duyệt điều chỉnh Quy...",
      secondBlock: [
        {
          content:
            "Chương trình phát triển đô thị Biển Động, huyện Lục Ngạn, tỉnh Bắc Giang đến năm 2035",
          date: "15/06/2024",
        },
        {
          content:
            "Bắc Giang phê duyệt kế hoạch sử dụng đất năm 2024 huyện Lạng Giang",
          date: "13/05/2024",
        },
        {
          content:
            "Phê duyệt Kế hoạch sử dụng đất năm 2024 của huyện Yên Dũng và Hiệp Hòa",
          date: "03/05/2024",
        },
        {
          content:
            "Phê duyệt Kế hoạch sử dụng đất thị xã Việt Yên, huyện Tân Yên năm 2024",
          date: "19/04/2024",
        },
      ],
    },
...
const dauThauTabs = [
  {
    ...
    content: {
      ...
      contentTitle:
        "Bệnh viện Y học Cổ truyền tỉnh Bắc Giang thông báo mời thầu",
      date: "20/12/2024",
      mainContent:
        "Ngày 19/12/2024, Bệnh viện Y học Cổ truyền tỉnh Bắc Giang ban hành Quyết định số 706/QĐ-BV phê...",
      secondBlock: [
        {
          content:
            "Thông báo bán đấu giá quyền sử dụng đất và tài sản gắn liền với đất có diện tích 433,8 m2",
          date: "18/12/2024",
        },
        {
          content:
            "Thông báo bán đấu giá quyền sử dụng và tài sản gắn liền trên đất tại huyện Sơn Động",
          date: "18/12/2024",
        },
        {
          content:
            "Thông báo bán đấu giá quyền sử dụng và tài sản gắn liền trên đất tại huyện Hiệp Hòa",
          date: "18/12/2024",
        },
        {
  ...
  },
  {
    ...
    content: {
      ...
      contentTitle:
        "Bắc Giang kêu gọi Đầu tư Dự án khu dịch vụ thương mại, thể dục thể thao hơn 186 tỷ đồng",
      date: "11/03/2024",
      mainContent:
        "Sở Kế hoạch và Đầu tư tỉnh Bắc Giang vừa thông báo, mời quan tâm đối với Dự án dịch vụ thương mại...",
      secondBlock: [
        {
          content:
            "Bắc Giang: Tìm nhà đầu tư cho dự án khu đô thị mới sân golf hơn 6.000 tỷ đồng",
          date: "07/03/2024",
        },
        {
          content:
            "Bắc Giang tìm nhà đầu tư khu đô thị 770 tỷ tại huyện Yên Dũng",
          date: "27/02/2024",
        },
        {
          content:
            "Phê duyệt chủ trương đầu tư cầu đường sắt Cẩm Lý huyện Lục Nam tỉnh Bắc Giang",
          date: "29/12/2023",
        },
        {
          content:
            "Bắc Giang: Phê duyệt chủ trương đầu tư Dự án khu đô thị số 5 huyện Yên Dũng",
          date: "28/12/2023",
        },
      ],
    },
...
const soBanNganhTabs = [
  {
    ...
    content: {
      ...
      date: "26/12/2024",
      mainContent:
        "Chiều 25/12, Chính phủ phối hợp với Ủy ban Thường vụ Quốc hội tổ chức hội nghị trực tuyến toàn...",
      secondBlock: [
        {
          content:
...
var huyenThixaThanhphoTabs = [
  {
    ...
    content: {
      ...
      date: "25/12/2024",
      mainContent:
        "Chiều 25/12, UBND tỉnh tổ chức hội nghị công bố Quyết định bổ nhiệm Phó Giám đốc Sở Công Thương...",
      secondBlock: [
        {
        ...
        {
          content:
            "Lục Ngạn: Nhiều hoạt động đặc sắc tại Hội chợ cam, bưởi và Tuần Du lịch năm 2024g",
          date: "21/12/2024",
        },
        {
          content:
            "Toàn văn phát biểu của Bí thư Tỉnh ủy Nguyễn Văn Gấu tại lễ ra mắt đơn vị hành chính thị xã Chũ...",
          date: "21/12/2024",
        },
        {
          content:
            "Hơn 30 gian hàng được trưng bày tại Hội chợ cam, bưởi và Tuần Du lịch Lục Ngạn năm 2024",
          date: "21/12/2024",
        },
      ],
    },
